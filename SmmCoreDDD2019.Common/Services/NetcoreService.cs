    ...
    public class NetcoreService : INetcoreService
    {
        ...
        public async Task CreateDefaultSuperAdmin()
        {
            try
            {
                ...
                superAdmin.PhoneNumber = _superAdminDefaultOptions.Handphone;
                superAdmin.Name = _superAdminDefaultOptions.FirstName;
                ...
                foreach (var item in typeof(SmmCoreDDD2019.Common.Pages.Pages).GetNestedTypes())
                {
                    var roleName = item.Name;
                    if (!await _roleManager.RoleExistsAsync(roleName)) { await _roleManager.CreateAsync(new ApplicationRole(roleName)); }
