    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NumentityerSequenceId = table.Column<int>(nullable: false)
                    ...
                    LastNumentityer = table.Column<int>(nullable: false),
                    NumentityerSequenceName = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NumberSequence", x => x.NumentityerSequenceId);
                });
