...
{
    public class CreateDataPegawaiDataOrmasCommandValidator:AbstractValidator<CreateDataPegawaiDataOrmasCommand>
    {
        public CreateDataPegawaiDataOrmasCommandValidator()
        {
