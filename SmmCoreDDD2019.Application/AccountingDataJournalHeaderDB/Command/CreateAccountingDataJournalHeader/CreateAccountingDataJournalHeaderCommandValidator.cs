...
{
    public class CreateAccountingDataJournalHeaderCommandValidator : AbstractValidator<CreateAccountingDataJournalHeaderCommand>
    {
        public CreateAccountingDataJournalHeaderCommandValidator()
        {
