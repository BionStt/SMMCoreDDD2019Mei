...
{
    public class UpdateStokUnitPembatalanPjCommandValidator : AbstractValidator<UpdateStokUnitPembatalanPjCommand>
    {
        public UpdateStokUnitPembatalanPjCommandValidator()
        {
