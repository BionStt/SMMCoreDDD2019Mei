...
namespace SmmCoreDDD2019.Application.DataPerusahaanStrukturJabatanDBs.Query.GetStructureByParent2
{
    public class GetStructureByParent2QueryHandler : IRequestHandler<GetStructureByParent2Query, GetStructureByParent2ViewModel>
    {
        ...
        public GetStructureByParent2QueryHandler(ISMMCoreDDD2019DbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<GetStructureByParent2ViewModel> Handle(GetStructureByParent2Query request, CancellationToken cancellationToken)
        {
            ...
            {
                DataStructureParent2DCs = _mapper.Map<IEnumerable<GetStructureByParent2LookUpModel>>(aa)
            };
            return model;
        }
    }
