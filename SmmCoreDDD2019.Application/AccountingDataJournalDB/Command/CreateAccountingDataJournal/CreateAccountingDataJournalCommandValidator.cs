...
{
    public class CreateAccountingDataJournalCommandValidator : AbstractValidator<CreateAccountingDataJournalCommand>
    {
        public CreateAccountingDataJournalCommandValidator()
        {
