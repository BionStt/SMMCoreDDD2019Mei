...
{
    public class GetDataJournalByKodeHeaderLookUpModel : IHaveCustomMapping
    {
        ...
        {
            configuration.CreateMap<AccountingDataJournal, GetDataJournalByKodeHeaderLookUpModel>()
