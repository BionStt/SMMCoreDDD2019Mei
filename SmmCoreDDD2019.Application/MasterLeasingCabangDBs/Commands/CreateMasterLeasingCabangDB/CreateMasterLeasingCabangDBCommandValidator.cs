...
{
   public class CreateMasterLeasingCabangDBCommandValidator : AbstractValidator<CreateMasterLeasingCabangDBCommand>
    {
        public CreateMasterLeasingCabangDBCommandValidator()
        {
