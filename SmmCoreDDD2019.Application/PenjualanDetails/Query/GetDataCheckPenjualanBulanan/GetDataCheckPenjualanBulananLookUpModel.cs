...
{
    public class GetDataCheckPenjualanBulananLookUpModel : IHaveCustomMapping
    {
        ...
        {
            configuration.CreateMap<PenjualanDetail, GetDataCheckPenjualanBulananLookUpModel>()
