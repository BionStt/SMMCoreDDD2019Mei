...
{
    public class GetDataPenjualanDetailByNoQueryHandler : IRequestHandler<GetDataPenjualanDetailByNoQuery, GetDataPenjualanDetailByNoViewModel>
    {
        private readonly ISMMCoreDDD2019DbContext _context;
        private readonly IMapper _mapper;
        public GetDataPenjualanDetailByNoQueryHandler(ISMMCoreDDD2019DbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        public async Task<GetDataPenjualanDetailByNoViewModel> Handle(GetDataPenjualanDetailByNoQuery request, CancellationToken cancellationToken)
        {
            ...
            var model = new GetDataPenjualanDetailByNoViewModel
            {
                GetDataPenjualanDetailByNoDS = _mapper.Map<IEnumerable<GetDataPenjualanDetailByNoLookUpModel>>(aa)
            };
            return model;
