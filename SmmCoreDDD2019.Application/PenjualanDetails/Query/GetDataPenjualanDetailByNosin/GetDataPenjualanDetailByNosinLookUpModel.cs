...
{
    public class GetDataPenjualanDetailByNosinLookUpModel : IHaveCustomMapping
    {
        ...
        {
            configuration.CreateMap<PenjualanDetail, GetDataPenjualanDetailByNosinLookUpModel>()
