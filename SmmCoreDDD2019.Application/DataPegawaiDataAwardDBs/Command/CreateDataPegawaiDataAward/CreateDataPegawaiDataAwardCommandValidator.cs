...
{
    public class CreateDataPegawaiDataAwardCommandValidator : AbstractValidator<CreateDataPegawaiDataAwardCommand>
    {
        public CreateDataPegawaiDataAwardCommandValidator()
        {
