...
{
    public class CreateMasterLeaveTypeHRDCommandValidator : AbstractValidator<CreateMasterLeaveTypeHRDCommand>
    {
        public CreateMasterLeaveTypeHRDCommandValidator()
        {
