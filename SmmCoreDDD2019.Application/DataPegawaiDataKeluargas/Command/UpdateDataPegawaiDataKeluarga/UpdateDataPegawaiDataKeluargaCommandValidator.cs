...
{
    public class UpdateDataPegawaiDataKeluargaCommandValidator:AbstractValidator<UpdateDataPegawaiDataKeluargaCommand>
    {
        public UpdateDataPegawaiDataKeluargaCommandValidator()
        {
