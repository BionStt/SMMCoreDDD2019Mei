...
namespace SmmCoreDDD2019.Application.DataPegawais.Command.DeleteDataPegawai
{
    public class DeleteDataPegawaiCommandHandler : IRequestHandler<DeleteDataPegawaiCommand>
    {
        ...
        public async Task<Unit> Handle(DeleteDataPegawaiCommand request, CancellationToken cancellationToken)
        {
            ...
            if (entity == null)
            {
                throw new NotFoundException(nameof(DataPegawai), request.Id);
            }
            ...
            _context.DataPegawai.Remove(entity);
