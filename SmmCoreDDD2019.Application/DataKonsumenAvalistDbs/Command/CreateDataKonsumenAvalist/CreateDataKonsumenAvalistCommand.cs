...
{
    public class CreateDataKonsumenAvalistCommand:IRequest
    {
        public int NoUrutKonsumen { get; set; }
        //[Display(Name = "No Register Konsumen")]
        //public string NoRegisterKonsumen { get; set; }
        [Display(Name = "Tanggal Register",Prompt ="Masukkan tanggal Registrasi"),DataType(DataType.Text)]
        ...
        [Display(Name = "Tanggal Lahir",Prompt ="Masukkan Tanggal Lahir"),DataType(DataType.Text)]
        public DateTime? Tanggallahir { get; set; }
        [Display(Name = "Tanggal Expire KTP"),DataType(DataType.Text)]
        ...
        [Display(Name = "Tanggal Mulai Usaha"),DataType(DataType.Text)]
        ...
        [Display(Name = "Tanggal Lahir Penjamin"),DataType(DataType.Text)]
        public DateTime? TanggalLahirPenjamin { get; set; }
        [Display(Name = "Tanggal Expire KTP Penjamin"),DataType(DataType.Text)]
