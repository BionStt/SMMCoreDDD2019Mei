...
namespace SMMCoreDDD2019.AdminLte.Controllers
{
    ...
    public class ManageController : Controller
    {
      ...
      //  private readonly IEmailSender _emailSender;
        ...
        public ManageController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, ILogger<ManageController> logger, UrlEncoder urlEncoder)
        {
