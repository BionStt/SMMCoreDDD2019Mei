...
{  
    ...
    public class AccountController : BaseController
    {
       ...
       private readonly ISmsSender _smsSender;
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Login2(SmmCoreDDD2019.Common.Identity.Models.AccountViewModels.LoginViewModel model, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
            {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Register(SmmCoreDDD2019.Common.Identity.ViewModel.Account.RegisterViewModel model, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, PhoneNumber = model.NoHandphone, IsEnabled = false };
